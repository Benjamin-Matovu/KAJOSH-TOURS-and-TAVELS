...
import { Plane, Mail, Lock, User, ArrowRight, Loader2, ShieldCheck, Eye, EyeOff, Globe } from 'lucide-react';
...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen relative flex flex-col items-center justify-center px-4 pt-24 pb-12 overflow-hidden">
      ...
      {/* Centralized Card */}
      <div className="w-full max-w-[500px] relative z-10 animate-in fade-in zoom-in-95 duration-500 max-h-[95vh] overflow-y-auto no-scrollbar">
        <div className="bg-white/95 dark:bg-slate-900/90 backdrop-blur-xl rounded-[2rem] shadow-2xl shadow-black/20 overflow-hidden border border-white/20 dark:border-slate-800">
          <div className="p-8 md:p-10">
            ...
            <div className="text-center mb-6">
              ...
              <h1 className="text-2xl font-black text-[#05203c] dark:text-white tracking-tight mb-1 transition-colors">Create Account</h1>
              <p className="text-slate-500 dark:text-slate-400 font-medium text-xs transition-colors">Join our global community of travelers.</p>
            </div>

            {/* Social Signups with REAL Icons */}
            <div className="space-y-2.5 mb-6">
              ...
              >
                ...
                <span className="text-sm font-bold text-slate-700 dark:text-slate-200">Sign up with Google</span>
              </button>
              ...
              <div className="grid grid-cols-2 gap-3.5">
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3.5 bg-slate-50 dark:bg-slate-800/50 border border-slate-50 dark:border-slate-800 rounded-xl focus:bg-white dark:focus:bg-slate-800 focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all outline-none font-bold text-slate-800 dark:text-white placeholder:text-slate-400 text-xs"
                  />
                </div>
          ...
          <div className="bg-slate-50/50 dark:bg-slate-900/50 p-4 flex items-center justify-center gap-2 border-t border-slate-100 dark:border-slate-800">
            ...
            <span className="text-[9px] font-black uppercase tracking-widest text-slate-400 dark:text-slate-500 transition-colors">
              World-class data protection and privacy
            </span>
          </div>
        </div>
      </div>
